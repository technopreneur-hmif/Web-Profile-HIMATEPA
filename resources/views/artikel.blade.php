...
<body class="bg-[#060606] text-white font-sans">
    <x-navbar/>
    <x-hero title="ARTIKEL" description="Website Resmi Himpunan Mahasiswa Ganasarkara Institut Teknologi Sumatera" />
        ...
        <div class="flex justify-center min-h-screen">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="p-6 rounded-lg w-[374px] h-[471px]">
                    <img src="{{ $artikel['image'] }}" alt="artikel" class="rounded-lg border-2 border-yellow-500 mb-4">
                    <div class="flex items-center justify-between text-[#C9A840] text-[13px] mb-2">
                        <span class="font-bold">{{ $artikel['division'] }}</span>
                        <span>{{ $artikel['date'] }}</span>
                    </div>
                    <h3 class="text-[20px] text-[#EDE5CE] font-bold mb-2">{{ $artikel['title'] }}</h3>
